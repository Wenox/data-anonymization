...
Anonymisation platform uses this tool to build the backend server. Maven is put into service in one of the two ways – depending on the selected environment – i.e.:
\begin{itemize}
...
Maven is also used to run the tests.
...
\begin{itemize}
\item Java 17
\item Spring Framework (Boot: Web, Data, Security, Test, Validation, Mail)
\item Hibernate + Hibernate types55
...
\item Rest assured
\item Swagger
\item Other libraries: commons lang3, bouncycastle, jjwt, ztexec
\end{itemize}
