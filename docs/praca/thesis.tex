...
New instance of the system database is preloaded with at least one admin account. The of this initial account can be configured from the properties and must be overriden in production:

\begin{itemize}
% application.yml
core.preloader.admin.login=admin@admin.com
core.preloader.admin.password=admin
\end{itemize}
