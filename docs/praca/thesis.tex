...
Furthermore, the labels with the increasing values of {XS}, {S}, {M}, {L}, and {XL} were being added to all the tasks upon creation to estimate the time-to-finish complexities. The distribution of the estimations is shown in Fig. \ref{fig:img:estimations}.
...
The application works intuitively. For brevity only the part of the most relevant functionalities could be shown in the screens.
...
User can upload a new database to generate the template from it, as shown in Fig. \ref{fig:template_uploading_view}.

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{img/app_template.png}
  \caption{Application -- new template panel}
  \label{fig:template_uploading_view}
\end{figure}

User can inspect the process of template generation in great details which is shown in Fig. \ref{fig:template_uploading_process}. The view is animated to provide user engagement.

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{img/app_template_ready.png}
  \caption{Application -- template uploading success}
  \label{fig:template_uploading_process}
\end{figure}

User can inspect and analyse the critical failures during template generation -- as displayed in Fig. \ref{fig:template_uploading_process_fail}.

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{img/app_template_fail.png}
  \caption{Application -- template uploading failure}
  \label{fig:template_uploading_process_fail}
\end{figure}


User can view templates he generated -- depicted in Fig. \ref{fig:templates_view1}.

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{img/app_templates.png}
  \caption{Application -- templates panel}
  \label{fig:templates_view1}
\end{figure}

User can view and download the computed metadata of the restored databases -- depicted in Fig. \ref{fig:metadata1}.

\begin{figure}
  \centering
  \includegraphics[width=0.85 \linewidth]{img/app_metadata.png}
  \caption{Application -- computed template metadata}
  \label{fig:metadata1}
\end{figure}

User can configure the anonymisation by adding the operation(s) that suit his business needs -- as shown in Fig. \ref{fig:generalisation_view}.

\begin{figure}
  \centering
  \includegraphics[width=0.85 \linewidth]{img/generalisation_view.png}
  \caption{Application -- configuring the anonymisation}
  \label{fig:generalisation_view}
\end{figure}

User can view and add the collected anonymisation operations for the selected table -- as visible in Fig. \ref{fig:app_view}.

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{img/app_operations_in_table.png}
  \caption{Application -- anonymisation operations for table}
  \label{fig:app_view}
\end{figure}
...
\begin{figure}
  ...
  \caption{Application -- worksheet summary panel}
  \label{fig:summary_view}
\end{figure}


User can access the worksheets he produced -- as shown in Fig. \ref{fig:allworksheetsv}.

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{img/app_worksheets_view.png}
  \caption{Application -- worksheets panel}
...
\begin{figure}
  ...
  \caption{Application -- outcomes panel}
  \label{fig:theoutcomes}
\end{figure}

Admin can access the tasks panel to inspect and run the tasks -- as shown in Fig. \ref{fig:app_scheduling}.

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{img/app_scheduling.png}
  \caption{Application -- tasks panel}
  \label{fig:app_scheduling}
\end{figure}

User can choose to delete his account as shown in Fig. \ref{fig:deleteacc} -- the possibility to undo this action by withdrawing the decision is available only for a limited time.

\begin{figure}
  \centering
  \includegraphics[width=0.4\linewidth]{img/app_delete_account.png}
  \caption{Application -- delete account notification}
  \label{fig:deleteacc}
\end{figure}
...
class ProcessExecutorFactory {
  static ProcessExecutor newProcess(String... cmd) {
    return new ProcessExecutor(cmd)
     .exitValue(0).readOutput(false).destroyOnExit();
  }
}
\end{minted}
...
\item[JDK] Java Development Toolkit 17
\item[JSON] JavaScript Object Notation
\item[JWT] JSON Web Token
\item[LHC] The Large Hadron Collider
\item[PaaS] Platform as a Service
\item[REST] Representational state transfer
\item[SOLID] Acronym for the five industry recognised design principles
