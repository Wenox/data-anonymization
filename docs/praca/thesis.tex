...
The communication with the anonymisation server is driven by the RESTful APIs. Available endpoints are listed in the table \ref{id:tab:rest_api}.

\begin{table}[]
\centering
\caption{Available REST resources.}
