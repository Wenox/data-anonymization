...
All of the tools have a shared goal in mind of being GDPR compliant. As shown, the existing solutions are greatly similar to the engineered software and often offer \textit{less} versatility than the designed anonymisation web platform.
