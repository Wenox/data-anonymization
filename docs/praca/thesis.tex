...
The platform is scanned by the SonarQube static analysis tool. This is great software, even for the enterprise-class level software, for finding the problems in code, including:
\begin{itemize}
\item code smells,
