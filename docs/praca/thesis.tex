...
System administrator and admin user must not be confused. The former is a technical user responsible for technical software processes such as configuration and deploy, whereas the latter is a non-technical business user responsible for managing the users.
...
\end{minted}
\caption{application-prod.yml – example.}
